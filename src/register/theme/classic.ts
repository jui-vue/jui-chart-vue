// Port of legacy `src/theme/classic.js` ("chart.theme.classic") - a flat, plain style-value
// object with no logic at all, so this is a byte-for-byte transcription of that file's returned
...
registerTheme('classic', classicTheme)
