...
// file's returned object (mechanically verified: every real style key plus every commented-out
// map-widget key - never ported anywhere in this project, matching `classic.ts`'s own precedent
// of preserving them as dead comments rather than dropping them - match the source exactly,
// key-for-key). Like `dark.ts`, declares its own module-scope `themeColors` array (here, named
